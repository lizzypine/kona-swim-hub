...
from accounts.views import (
    LearnerDetailView,
    RegisterThanksPageView,
    contactView,
    ContactThanksPageView,
    ContactInstructorThanks,
)
...
urlpatterns = [
    ...
    path(
        ...
        ContactThanksPageView.as_view(),
        name="contact_thanks",
    ),
    path(
        "contact_instructor/<int:pk>",
        views.contact_instructor,
        name="contact_instructor",
    ),
    path(
        "thanks/", ContactInstructorThanks.as_view(), name="contact_instructor_thanks"
    ),
