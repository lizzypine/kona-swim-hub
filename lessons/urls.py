...
from lessons.views import CourseListView, CourseDetailView, ThanksPageView, CourseDetailView, RegisterLearner, CourseDeleteView, JoinWaitlist, MoveWaitlistedToRoster
